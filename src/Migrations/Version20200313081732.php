 ...
 */
final class Version20200313081732 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD contract VARCHAR(255) DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE subsribed_work_order subsribed_work_order TINYINT(1) DEFAULT NULL, CHANGE subscribed_ticket subscribed_ticket TINYINT(1) DEFAULT NULL, CHANGE subscribed_responsible_ticket subscribed_responsible_ticket TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hours CHANGE workorder_id workorder_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ticket CHANGE user_id user_id INT DEFAULT NULL, CHANGE company_id company_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE user DROP contract, CHANGE roles roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_bin`, CHANGE subsribed_work_order subsribed_work_order TINYINT(1) DEFAULT \'NULL\', CHANGE subscribed_ticket subscribed_ticket TINYINT(1) DEFAULT \'NULL\', CHANGE subscribed_responsible_ticket subscribed_responsible_ticket TINYINT(1) DEFAULT \'NULL\'');
