 ...
 */
final class Version20200211103608 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE user_id user_id INT DEFAULT NULL, CHANGE company_id company_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME NOT NULL');
